...
void debug_menu_render(UiRenderer *renderer, const ClientGame *game) {
  ...
  RENDER_BUTTON({.message = "Beings",
                 ...
                 .x_offset = x_offset,
                 .y_offset = y_offset});
  RENDER_BUTTON({.message = opts->collisions_enabled ? "Collisions: On" : "Collisions: Off",
                 .texture = DEBUG_BUTTON_TEXTURE,
                 .selected_texture = DEBUG_BUTTON_SELECTED_TEXTURE,
                 ...
                 .width = 100,
                 .height = 16});
  RENDER_BUTTON({.message = opts->hitboxes_shown ? "Hitboxes: Shown" : "Hitboxes: Hidden",
                 .texture = DEBUG_BUTTON_TEXTURE,
                 .selected_texture = DEBUG_BUTTON_SELECTED_TEXTURE,
                 ...
                 .width = 120,
                 .height = 16});
  RENDER_BUTTON({.message = opts->print_tile_debug_info ? "Print tile info" : "Don't Print tile info",
                 .texture = DEBUG_BUTTON_TEXTURE,
                 .selected_texture = DEBUG_BUTTON_SELECTED_TEXTURE,
